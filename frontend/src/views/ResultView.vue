<template>
  <div class="result-view">
    ...
    <main class="result-view__chapters">
      ...
      <result-card title="INDEX">
        <v-row class="no-gutters">
          ...
          <v-col class="col-7 ml-1">
            <nav class="result-view__navigation">
              <dl class="result-view__abouts">
                <div v-for="(chapter, i) in chapters" class="result-view__about" :style="{ gridRow: (i + 1) % 4 }">
                  <dt>{{ chapter.title }}</dt>
      ...
      <!-- 항목 별 생성 기능 -->
      <div v-for="(chapter) in chapters" :key="chapter.chapter" class="result-view__chapter">
          <result-card :title="`Chapter ${chapter.chapter}. ${chapter.title}`">
            <p>{{ chapter.description }}</p>

            <div v-if="chapter.data" class="result-view__charts">
              <!--
              <bar-chart :data="chapter.data" />
              -->
            </div>
          </result-card>
        </div>
